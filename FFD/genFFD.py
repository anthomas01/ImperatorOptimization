...
#exhaust
corners[3, 0, :] = [4.27, -0.0381, -0.0381]
corners[3, 1, :] = [4.27, -0.0381, 0.0381]
corners[3, 2, :] = [4.27, 0.0381, -0.0381]
corners[3, 3, :] = [4.27, 0.0381, 0.0381]
corners[3, 4, :] = [4.32, -0.0381, -0.0381]
corners[3, 5, :] = [4.32, -0.0381, 0.0381]
corners[3, 6, :] = [4.32, 0.0381, -0.0381]
corners[3, 7, :] = [4.32, 0.0381, 0.0381]
