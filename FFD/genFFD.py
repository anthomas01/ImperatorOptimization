...
#boattail
corners[3, 0, :] = [4.1656, -0.11, 0]
corners[3, 1, :] = [4.1656, 0, 0.11]
corners[3, 2, :] = [4.1656, 0.11, 0]
corners[3, 3, :] = [4.1656, 0, -0.11]
corners[3, 4, :] = [4.275, -0.11, 0]
corners[3, 5, :] = [4.275, 0, 0.11]
corners[3, 6, :] = [4.275, 0.11, 0]
corners[3, 7, :] = [4.275, 0, -0.11]
